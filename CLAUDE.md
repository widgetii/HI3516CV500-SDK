...
- `mpi/mpi_ao.c`, `mpi/mpi_audio.c`, `mpi/mpi_bind.c`
...
- **`mpi_ai`** — substantial C source exists but is commented out of the build; contains an empty TODO function (`mpi_ai_chn_get_frm_proc`)
