...
HI_S32 DNVQE_CacheWrite(DNVQE_Cache_S *pstCache, HI_S32 u32NodeSize,
    HI_CHAR *pData, HI_S32 u32Samples);
HI_S32 DNVQE_CacheRead(DNVQE_Cache_S *pstCache, HI_S32 u32NodeSize,
    HI_CHAR *pOutBuf, HI_S32 u32Samples);
HI_S32 DNVQE_CacheProcessWriteInBuf(DNVQE_CTX *pDnVqeCtx,
    HI_S16 *ps16SinBuf, HI_S32 u32Samples);
HI_S32 HI_DNVQE_ReadFrame(DNVQE_CTX *pDnVqeCtx, HI_S16 *ps16SouBuf,
    HI_S32 u32Samples, HI_S32 bBlock);
HI_S32 DNVQE_CacheProcessFrame(DNVQE_CTX *pDnVqeCtx);
HI_S32 HI_DNVQE_ProcessFrame(DNVQE_CTX *pDnVqeCtx,
    HI_S16 *ps16SinBuf, HI_S16 *ps16SouBuf);
HI_S32 HI_DNVQE_WriteFrame(DNVQE_CTX *pDnVqeCtx,
    HI_S16 *ps16SinBuf, HI_S16 *ps16SouBuf);
